...
export default function HospitalMapPage() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-64px)] w-full max-w-md mx-auto">
      {/* Header */}
      <div className="flex items-center justify-between px-4 py-3 border-b border-border bg-background z-10 shrink-0 shadow-sm">
        ...
        <button
          ...
          className="p-1.5 -mr-1.5 rounded-full hover:bg-accent text-muted-foreground hover:text-primary transition-colors"
